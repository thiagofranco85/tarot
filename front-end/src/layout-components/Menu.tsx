...
export function Menu() {
  ...
  return (
    <nav className="relative">
      <button
        className="flex ml-auto mr-2 mt-2 mb-2.5 cursor-pointer md:hidden"
        onClick={toggleMenu}
      >
        <MenuIcon
          size={32}
          className="text-white z-1 hover:text-hover-primary"
        />
      </button>

      <menu
        className={`flex flex-col absolute top-full left-0 right-0 
      ...
      >
        ...
        <li>
          <Text variant={"title-xs"}>
            <NavLink to="/pagina-do-dev">Página do Dev.</NavLink>
          </Text>
        </li>
      </menu>
